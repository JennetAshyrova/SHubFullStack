...
namespace Konu08SiniflarClasses
{
    ...
    {
        string kurucuMetot;
        public SiniftaMetotKullanimi()   //ctor yazıp tab kurucu method-constructor oluşturuyoruz.
        {
            Console.WriteLine();
        ...
        public static string StatikDegisken = "sınfta statik degisken kullanımı";
